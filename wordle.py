...
def preview_game():
    ...
    print(
        ...
        'введёте слово которое не существует или его нет в нашем словаре, то вы уведите фразу:"ОУ! Такого слова нет '
        'в словаре игры!"\n   Также, вам будет предложено случайное слово из словаря игры.')
    print()
